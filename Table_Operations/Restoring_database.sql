-- REstroring the databse is much impo' after customizing the database
-- This is the last step of the database customization

-- Path: Table_Operations\Restoring_database.sql
